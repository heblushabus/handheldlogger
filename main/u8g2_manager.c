...
#else
#define I2C_FREQ_HZ CONFIG_I2C_MASTER_FREQUENCY
#endif

#ifndef CONFIG_I2C_DISPLAY_ADDRESS
...
void u8g2_manager_draw_ui(int voltage_mv, float temp, float humidity, float iaq, int iaq_accuracy)
{
  u8g2_ClearBuffer(&u8g2);
  char buf[32];
